...
namespace can_control
{
  ...
  DgtCanControl::DgtCanControl()
  {
  	...
  	cmd_sub_ = nh_.subscribe<geometry_msgs::TwistStamped>("smoother_cmd_vel", 5, &DgtCanControl::CmdCallBack, this);
  ...
  void DgtCanControl::CmdCallBack(const geometry_msgs::TwistStamped::ConstPtr& cmd_msg)
  {
