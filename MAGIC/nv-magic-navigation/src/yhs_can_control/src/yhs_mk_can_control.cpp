...
namespace can_control
{
  ...
  MkCanControl::MkCanControl()
  {
    ...
    ctrl_cmd_sub_ = nh_.subscribe<yhs_msgs::MkCtrlCmd>("ctrl_cmd", 5, &MkCanControl::CtrlCmdCallBack, this);
  	...
  	cmd_sub_ = nh_.subscribe<geometry_msgs::TwistStamped>("smoother_cmd_vel", 5, &MkCanControl::CmdCallBack, this);
  ...
  void MkCanControl::CmdCallBack(const geometry_msgs::TwistStamped::ConstPtr& cmd_msg)
  {
