#ifndef __YHS_FR_CAN_CONTROL_H__
#define __YHS_FR_CAN_CONTROL_H__
...
{
  class FrCanControl : public yhs_chassis::CanControl
  {
  ...
  private:
    ...
    bool WaitForCanFrame();
  	void IoCmdCallBack(const yhs_msgs::FrIoCmd::ConstPtr& io_cmd_msg);
  	void CtrlCmdCallBack(const yhs_msgs::FrCtrlCmd::ConstPtr& ctrl_cmd_msg);
