...
//public nav_core::BaseLocalPlanner表示RegulatedPurePursuitController类从nav_core::BaseLocalPlanner类继承，并且派生类可以直接访问基类的公共成员。
//RegulatedPurePursuitController类通过继承自nav_core::BaseLocalPlanner类，获得了基类的接口和功能。
