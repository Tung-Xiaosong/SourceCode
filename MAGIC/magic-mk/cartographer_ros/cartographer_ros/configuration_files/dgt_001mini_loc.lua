...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.hit_probability = 0.65 --0.55
...
POSE_GRAPH.optimization_problem.odometry_translation_weight = 1e-1 
...
POSE_GRAPH.optimize_every_n_nodes = 1 --|>太大，初始化很慢 5

POSE_GRAPH.constraint_builder.sampling_ratio = 0.3 --|> 三分之一采样
